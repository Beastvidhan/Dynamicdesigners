  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black px-6 sm:px-16 py-20">
      ...
      >
        ...
        <img 
          src="https://res.cloudinary.com/dndfx6ulv/image/upload/v1769770815/rudraksha_nc6swq.png"
          className="w-40 h-40 rounded-full border-4 border-indigo-500 object-cover"
        />

        <div>
          <h1 className="text-4xl font-bold">Rudraksh</h1>
          <p className="text-indigo-500 mt-1">AutoCAD Designer</p>

          <p className="mt-5 text-gray-600 dark:text-gray-400">
            Rudraksh focuses on Transforming ideas into precise, detailed technical designs using AutoCAD.
            Creating accurate and efficient design solutions through AutoCAD expertise.
            Bringing concepts to life with precision-driven CAD design.
          </p>

          <div className="mt-6 flex flex-wrap gap-3">
            {["precision", "technical design", "real-world application", "creativity + engineering thinking"].map(skill => (
