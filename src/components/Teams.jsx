...
const Teams = () => {
  ...
  return (
    ...
    >
      ...
      <Title 
        title='Meet the team' 
        desc='Developers, designers, and hackathon enthusiasts here to guide you at every step.'
      />
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5'>
        {teamData.map((team, index) => (
          ...
          <motion.div
           ...
           onClick={() => navigate(`/team/${team.slug || team.name.toLowerCase().replace(/\s+/g, "")}`)}
            ...
            hover:scale-103 transition-all duration-400 cursor-pointer'
          >
